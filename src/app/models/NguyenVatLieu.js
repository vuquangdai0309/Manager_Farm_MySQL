...
const nguyenlieuModle = {
    ...
    // getTreeById: (Id, callback) => {
    //     const query = 'SELECT * FROM nguyenvatlieu WHERE tree_id = ?';
    ...
    creatNguyenLieu: (nguyenvatlieu, callback) => {
        ...
        const values = [nguyenvatlieu.name, nguyenvatlieu.lieuluong, nguyenvatlieu.nongdo, nguyenvatlieu.thoigiancachlythuoc, nguyenvatlieu.mucdich, nguyenvatlieu.thietbi]
        connection.query(query, values, callback)
    },
    updateNguyenLieu: (Id, nguyenvatlieu, callback) => {
        ...
        const values = [nguyenvatlieu.name, nguyenvatlieu.lieuluong, nguyenvatlieu.nongdo, nguyenvatlieu.thoigiancachlythuoc, nguyenvatlieu.mucdich, nguyenvatlieu.thietbi, Id]
        connection.query(query, values, callback)
    }
}
